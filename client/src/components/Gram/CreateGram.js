...
const CreateGram = ({ currentId, setCurrentId }) => {
    ...
    const [gramData, setGramData] = useState({creator: '', title: '', selectedImage: '', description: ''});
        ...
        <div className="gram">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    <input
                        type="text"
                        value={gramData.description}
                        placeholder="Description"
                        onChange={(e) => setGramData({...gramData, description: e.target.value })}
                    />
                </div>
